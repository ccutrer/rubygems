...
module Bundler
  class Runtime
    ...
    def prune_cache(cache_path)
      ...
      resolve = @definition.resolve.to_a + Plugin.installed_specs(@definition)
    ...
    def clean(dry_run = false)
      ...
      all_specs = Bundler.rubygems.add_default_gems_to(specs).values + Plugin.installed_specs(@definition)
